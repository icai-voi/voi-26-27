\chapter{Apartado B: \textbf{Segmentación por color}}
...
\addcontentsline{toc}{section}{Tarea B.4: Segmentación de las partes naranjas}
...
\addcontentsline{toc}{section}{Tarea B.5: Segmentación de las partes blancas}
...
\addcontentsline{toc}{section}{Tarea B.6: Combinación de máscaras}
...
\addcontentsline{toc}{section}{Tarea B.7: Guardado de imágenes}
...
Segmente por color el escudo de su equipo deportivo favorito: descompóngalo en al menos 3 colores. De igual forma que ha realizado en el ejercicio de clase, proporcione las máscaras binarias de cada color. Además, multiplique la máscara con la imagen original para visualizar solamente el color de interés. Por último indique el porcentaje que representa cada color sobre el total del escudo.
\end{tcolorbox}
